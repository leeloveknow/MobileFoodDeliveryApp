class RestaurantBrowsing:
    ...
    def search_by_delivery_time(self, min_delivery_time, max_delivery_time):
        """
        Search for restaurants based on their delivery time.

        Args:
            min_delivery_time (int): The minimum delivery time in minutes.
            max_delivery_time (int): The maximum delivery time in minutes.

        Returns:
            list: A list of restaurants that match the given delivery time range.
        """
        return [restaurant for restaurant in self.database.get_restaurants()
                if min_delivery_time <= restaurant['delivery_time'] <= max_delivery_time]
